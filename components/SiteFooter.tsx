...
// Light grey footer band closing every page: one lean line holding the name,
// phone, email and the grouped social icons with generous gaps (owner request
// 2026-07-12), copyright on its own second line.
